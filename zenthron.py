...
async def kill(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None: await _handle_action_command(update, context, KILL_TEXTS, ["explosion", "boom", "rekt"], "kill", True, "Who to 'kill'? Reply or use /kill @username.")
async def punch(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None: await _handle_action_command(update, context, PUNCH_TEXTS, ["punch", "fight"], "punch", True, "Who to 'punch'? Reply or use /punch @username.")
