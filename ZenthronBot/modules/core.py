...
def load_handlers(application: Application):
    ...
    application.add_handler(CustomPrefixHandler("ping", ping_command, custom_prefixes=prefixes))
    ...
    application.add_handler(CustomPrefixHandler("speedtest", speedtest_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("listsudo", list_sudo_users_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("listgroups", list_groups_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("delgroup", del_groups_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("cleangroups", clean_groups_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("addsudo", addsudo_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("delsudo", delsudo_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("adddev", adddev_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("deldev", deldev_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("listdevs", listdevs_command, custom_prefixes=prefixes)) 
    application.add_handler(CustomPrefixHandler(["whitelist", "wlist"], whitelist_user_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler(["unwhitelist", "unwlist"], unwhitelist_user_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("addsupport", addsupport_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("delsupport", delsupport_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("setrank", setrank_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("listsupport", listsupport_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("listwhitelist", listwhitelist_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler("broadcast", broadcast_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler(["shell", "sh"], shell_command, custom_prefixes=prefixes))
    application.add_handler(CustomPrefixHandler(["execute", "exe"], execute_script_command, custom_prefixes=prefixes))
